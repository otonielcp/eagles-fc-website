...
import { updateVideo, uploadVideoThumbnail } from "@/actions/video";
...
export default function EditVideoForm({ video, onCancel, onVideoUpdated }: EditVideoFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await updateVideo(video._id, formData);
      
      if (result.success && result.video) {
        toast.success(result.message);
        onVideoUpdated(result.video);
      } else {
