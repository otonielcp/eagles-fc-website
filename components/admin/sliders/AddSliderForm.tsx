...
import { createSlider, uploadSliderImage, uploadSliderLogo } from "@/actions/slider";
import { SliderFormData, SliderType, GameSliderData } from "@/types/slider";
...
export default function AddSliderForm() {
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle>Add Hero Slider</CardTitle>
      </CardHeader>
