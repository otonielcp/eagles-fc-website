...
export default function AddPlayerForm({ team }: AddPlayerFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        router.push(`/admin/teams/${team._id}/players`);
      } else {
        toast.error(result.message);
      }
    } catch (error) {
      toast.error("An error occurred while creating the player");
      console.error(error);
    } finally {
  ...
  return (
    <Card>
      <form onSubmit={handleSubmit}>
        <CardHeader>
          <CardTitle>Add New Player to {team.name}</CardTitle>
        </CardHeader>
        ...
        <CardFooter className="flex justify-between">
          <Button
            type="button"
            variant="outline"
            onClick={() => router.push(`/admin/teams/${team._id}/players`)}
          >
            Cancel
          </Button>
          <Button
