...
import { createPortfolioLogo, uploadLogoImage } from "@/actions/sponsorsLogo";
...
export default function AddLogoForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await createPortfolioLogo(formData);
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        <CardTitle>Add Portfolio Logo</CardTitle>
      </CardHeader>
          ...
          <div className="space-y-2">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="Primary">Primary Sponsor</SelectItem>
