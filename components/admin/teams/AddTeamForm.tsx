...
import { createTeam, uploadTeamImage } from "@/actions/team";
...
export default function AddTeamForm() {
  ...
  const [categoryType, setCategoryType] = useState<"standard" | "custom">("standard");
  ...
  const handleCategoryTypeChange = (type: "standard" | "custom") => {
    ...
    if (type === "standard" && formData.category !== "Senior" && 
        !["Senior", "U23", "U19", "U17", "U15", "Women", "Veterans", "Academy"].includes(formData.category)) {
          ...
          <div className="space-y-6 mt-8">
            <div>
              ...
              <p className="text-muted-foreground text-sm">
                Add sponsor information for this team
              </p>
            </div>
