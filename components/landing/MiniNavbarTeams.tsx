...
const MiniNavbarTeams = ({ currentTeam, similarTeams }: MiniNavbarTeamsProps) => {
  ...
  return (
    <div className="border-b border-gray-200 bg-gray-50 shadow-lg w-full overflow-x-auto">
      <div className="flex justify-start ml-72 md:ml-80 lg:ml-96 xl:ml-[28rem] space-x-8 text-gray-500 uppercase text-sm tracking-wide px-6 py-3 whitespace-nowrap">
