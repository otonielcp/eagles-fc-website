    ...
    <div className="relative w-full bg-white">
      ...
      <div className="max-w-[1600px] mx-auto">
        ...
        <div className="grid lg:grid-cols-[55%,45%]">
          ...
          {/* Content Section */}
          <div className="px-8 sm:px-12 lg:px-20 py-20 lg:py-32 flex flex-col justify-center">
            ...
            >
              ...
              {/* Main heading */}
              <h1 className="text-6xl sm:text-7xl lg:text-8xl font-black tracking-tight mb-10 leading-[0.9]">
              ...
              <div className="space-y-6 mb-12 max-w-2xl">
                <p className="text-xl text-gray-700 leading-[1.7]">
              ...
              <div className="grid grid-cols-3 gap-8 mb-12 max-w-2xl">
                <div className="border-l-2 border-[#C5A464] pl-4">
          ...
          >
            <div className="absolute inset-0 lg:sticky lg:top-0 lg:h-screen">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 lg:p-12">
                <div className="bg-white/95 backdrop-blur-sm p-6 lg:p-8 rounded-lg shadow-2xl border border-white/20">
                  <p className="text-lg lg:text-xl text-gray-900 italic leading-relaxed font-medium">
